...
describe('public account configuration',()=>{
  ...
  it('never exposes server secrets',()=>{
    ...
    expect(c).toEqual({enabled:true,supabaseUrl:'https://test.supabase.co',publishableKey:'sb_publishable_example',apiBase:'https://test.onrender.com',emailAuthReady:false});
  });
